                ...
                <li class="dropdown user-menu">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right ec-dropdown-menu">
                        ...
                        <li class="dropdown-header">
                            <img src="{{ asset('admin_assets/img/user/user.png') }}" class="img-circle" alt="User Image" />
                                    ...
                                    <ul class="list-unstyled" data-simplebar style="height: 360px">
                                        <li>
                                            <a href="javscript:void(0)" class="media media-message media-notification">
                                                <div class="position-relative mr-3">
                                                    <img class="rounded-circle" src="{{ asset('asmin_assets/img/user/u2.jpg') }}" alt="Image">
                                        ...
                                        <li>
                                            <a href="javscript:void(0)" class="media media-message media-notification media-active">
                                                <div class="position-relative mr-3">
                                                    <img class="rounded-circle" src="{{ asset('admin_assets/img/user/u1.jpg') }}" alt="Image">
